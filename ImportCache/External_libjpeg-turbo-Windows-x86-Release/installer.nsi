...
OutFile ".\${BUILDDIR}libjpeg-turbo-3.0.90-vc.exe"
...
!endif
	...
	WriteRegStr HKLM "SOFTWARE\libjpeg-turbo 3.0.90" "Install_Dir" "$INSTDIR"

	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\libjpeg-turbo 3.0.90" "DisplayName" "libjpeg-turbo SDK v3.0.90 for Visual C++"
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\libjpeg-turbo 3.0.90" "UninstallString" '"$INSTDIR\uninstall_3.0.90.exe"'
	WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\libjpeg-turbo 3.0.90" "NoModify" 1
	WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\libjpeg-turbo 3.0.90" "NoRepair" 1
...
!endif
	...
	DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\libjpeg-turbo 3.0.90"
	DeleteRegKey HKLM "SOFTWARE\libjpeg-turbo 3.0.90"
