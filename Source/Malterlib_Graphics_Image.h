...
namespace NMib
{
	namespace NGraphics
	{
		...
		typedef TCImageDimensions<NMath::CVec4Duint32> CImageDimensions;
		typedef TCImageStride<NMath::CVec4Duint32> CImageStride;
		typedef TCImageRect<NMath::CVec4Duint32> CImageRect;
